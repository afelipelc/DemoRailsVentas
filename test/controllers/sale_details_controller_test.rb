...
class SaleDetailsControllerTest < ActionController::TestCase
  ...
  test "should create sale_detail" do
    assert_difference('SaleDetail.count') do
      post :create, sale_detail: { cantidad: @sale_detail.cantidad, importe: @sale_detail.importe, preciounitario: @sale_detail.preciounitario, product_id: @sale_detail.product_id, sale_id: @sale_detail.sale_id }
    end
  ...
  test "should update sale_detail" do
    patch :update, id: @sale_detail, sale_detail: { cantidad: @sale_detail.cantidad, importe: @sale_detail.importe, preciounitario: @sale_detail.preciounitario, product_id: @sale_detail.product_id, sale_id: @sale_detail.sale_id }
    assert_redirected_to sale_detail_path(assigns(:sale_detail))
  end
